...
/// <summary>
/// The variable values for a given point in EOU, based on what set of flags are true.
/// </summary>
[TableComponent(0x20)]
public class GatherPointV3Set(U8[] data)
{
  /// <summary>
  ...
  /// <summary>
  /// This flag must be false for this set to be loaded. Boy do I not like that name. It's also unused in EOU.
  /// </summary>
