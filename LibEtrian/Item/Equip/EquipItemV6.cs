...
/// <summary>
/// An entry in the EON version of equipitemtable.tbl, which defines data for equipment.
/// </summary>
[TableComponent(0x4C)]
public class EquipItemV6(U8[] data)
{
  /// <summary>
  ...
  /// <summary>
  /// This was moved into what's usually reserved for numeric modifiers in EON for some reason. Determines what this
  /// item is exchanged for when recycled.
  /// </summary>
  public U8 RecycleType { get; } = data[0x10];

  /// <summary>
  /// The vulnerability modifiers on this item.
  /// </summary>
  public U8[] VulnerabilityModifiers { get; } = data.Skip(0x11).Take(21).ToArray();
  ...
  /// <summary>
  /// The item's speed modifier. In EON, this is added/subtracted from a base 1.0x multiplier that's applied to the
  ...
  /// <summary>
  /// Unknown. This is always 0 in EON.
  /// </summary>
  ...
  /// <summary>
  /// The item's forge flags, i.e. can it be forged, etc.
  /// </summary>
